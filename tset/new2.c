...
int main() {
    ...
    for(int i=0;i<ext_size;i++){
        ...
        char *_nodetype = json_get_string(ext_type, "_nodetype");
        printf("%s\n",_nodetype);
    ...
    // for(int i =0;i< ext_size;i++){
    //     printf("ext_array[%d] : ",i);
    //     json_value obj2 = json_get(ext_array, i);
    //     char _nodetype = json_get_string(obj2, "_nodetype");
